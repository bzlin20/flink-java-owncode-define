...
/**
 * @ClassName: StateProcessFunction
 * @Description: 包含一个ValueState操作的ProcessFunction，仅供作业恢复测试。
 * @author: ds-longju
 * @Date: 2022-09-04 09:29
 * @Version 1.0
 **/
public class StateProcessFunction extends KeyedProcessFunction<Tuple, Tuple3<String, Integer, Long>, Tuple3<String, Integer, Long>> {
